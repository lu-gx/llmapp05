  ...
  - Docker Hub Login — Authenticates using lugx and the          
  ...
  │      Workflow       │             Image              │             
  ├─────────────────────┼────────────────────────────────┤             
  │ llm-multiroute      │ lugx/llm-multiroute      │             
  ├─────────────────────┼────────────────────────────────┤             
  │ llm-frontend-python │ lugx/llm-frontend-python │             
  └─────────────────────┴────────────────────────────────┘             
  Required secret
  Add this in your repo settings (Settings > Secrets and variables > Actions):
  Secret: DOCKERHUB_TOKEN
  Purpose: Docker Hub access token for lugx (generate at https://hub.docker.com/settings/security)
